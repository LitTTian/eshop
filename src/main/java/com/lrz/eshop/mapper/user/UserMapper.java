...
public interface UserMapper extends BaseMapper<User> {
    ...
    //                 many = @Many(select = "com.lrz.eshop.mapper.product.ModelMapper.selectBySellerId")
    //         ),
    //         @Result(property = "buys", column = "id", javaType = List.class,
    //                 many = @Many(select = "com.lrz.eshop.mapper.trade.TradeMapper.selectByBuyerId")
    //         ),
    ...
    @Results({
            ...
            //         many = @Many(select = "com.lrz.eshop.mapper.star.StarMapper.selectModelStarsByUserId")
            // ),
            // @Result(property = "articleStars", column = "id", javaType = List.class,
            //         many = @Many(select = "com.lrz.eshop.mapper.star.StarMapper.selectArticleStarsByUserId")
            // ),
            // @Result(property = "peopleStars", column = "id", javaType = List.class,
            //         many = @Many(select = "com.lrz.eshop.mapper.star.StarMapper.selectPeopleStarsByUserId")
            // ),
/*             @Result(property = "models", column = "id", javaType = List.class,
                    many = @Many(select = "com.lrz.eshop.mapper.product.ModelMapper.selectBySellerId")
            ),
