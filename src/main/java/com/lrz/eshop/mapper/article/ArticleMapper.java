...
public interface ArticleMapper extends BaseMapper<Article> {
     ...
     * @return
     */
    @Select("select * from article where category_id = #{categoryId} order by watches desc limit #{limit}")
    @Results({
            @Result(property = "id", column = "id"),
            @Result(property = "userId", column = "user_id"),
            @Result(property = "user", column = "user_id", javaType = UserSocialInfo.class,
    ...
    List<ArticleShowInfo> selectMostWatchesArticleCardByCategoryId(String categoryId, int limit);
