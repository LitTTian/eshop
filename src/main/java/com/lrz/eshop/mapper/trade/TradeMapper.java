package com.lrz.eshop.mapper.trade;
...
public interface TradeMapper extends BaseMapper<Trade> {
    ...
    @Results({
            ...
            @Result(property = "location", column = "location_id", javaType = Location.class,
                    one = @One(select = "com.lrz.eshop.mapper.user.LocationMapper.selectById")
            ),
            ...
            @Result(property = "tradeDetails", column = "id", javaType = List.class,
                    many = @Many(select = "com.lrz.eshop.mapper.trade.TradeDetailMapper.selectByTradeId")
            ),
    })
